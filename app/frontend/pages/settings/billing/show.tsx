...
export default function Billing() {
  const { current_plan, subscription_status, payments, stripe_customer_id } =
    usePage<BillingProps>().props
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge variant={variants[status] || "outline"}>{translatedStatus}</Badge>
    )
  }
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t("settings.billing.current_plan_description")}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {current_plan ? (
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    {subscription_status && (
                      <div>{getStatusBadge(subscription_status)}</div>
                    )}
                  </div>
