...
const translations: Record<string, Translations> = {
  "es-MX": {
    ...
    "settings.email.title": "Dirección de correo",
    "settings.email.subtitle": "Actualiza tu correo electrónico",
    "settings.email.current": "Correo actual",
    "settings.email.new": "Nuevo correo",
    "settings.email.save": "Guardar",
    "settings.password.title": "Actualizar contraseña",
    "settings.password.subtitle": "Asegúrate de usar una contraseña segura",
    ...
    "settings.password.save": "Guardar",
    "settings.sessions.title": "Sesiones activas",
    "settings.sessions.subtitle": "Administra tus sesiones activas",
    "settings.sessions.current": "Sesión actual",
    "settings.sessions.revoke": "Cerrar sesión",
    "settings.appearance.title": "Apariencia",
    "settings.appearance.subtitle": "Personaliza la apariencia de la aplicación",
