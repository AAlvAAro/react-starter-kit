...
const translations: Record<string, Translations> = {
  "es-MX": {
    ...
    "dashboard.subtitle": "¡Bienvenido de nuevo! Esto es lo que está pasando con tu tienda.",
    ...
    "catalog.no_products_search": "Intenta ajustar tu búsqueda o criterios de filtro.",
    ...
    "customers.no_customers_search": "Intenta ajustar tus criterios de búsqueda.",
    "customers.delete_confirm": "¿Estás seguro de que quieres eliminar a {name}?",
    "customers.contact_information": "Información de contacto",
    "customers.name": "Nombre",
    "customers.phone": "Teléfono",
    "customers.customer_stats": "Estadísticas del cliente",
    "customers.total_orders": "Total de pedidos",
    "customers.notes": "Notas",
    "customers.new_customer_title": "Nuevo cliente",
    "customers.new_customer_subtitle": "Agrega un nuevo cliente a tu base de datos",
    "customers.edit_customer_title": "Editar cliente",
    "customers.edit_customer_subtitle": "Actualiza la información del cliente",
    "customers.name_placeholder": "Ingresa el nombre del cliente",
    "customers.email_placeholder": "cliente@ejemplo.com",
    "customers.phone_optional": "Teléfono (opcional)",
    "customers.phone_placeholder": "+52 (555) 123-4567",
    "customers.notes_optional": "Notas (opcional)",
    "customers.notes_placeholder": "Agrega cualquier nota sobre este cliente",
    "customers.create_customer": "Crear cliente",
    "customers.update_customer": "Actualizar cliente",
    "customers.save_changes": "Guardar cambios",
    "customers.cancel": "Cancelar",

    // Orders
    "orders.title": "Pedidos",
    "orders.subtitle": "Crea y administra cotizaciones para tus clientes",
    "orders.new_order": "Nuevo pedido",
    "orders.add_order": "Agregar pedido",
    "orders.search_orders": "Buscar pedidos...",
    "orders.no_orders": "No se encontraron pedidos",
    "orders.no_orders_hint": "Comienza creando tu primer pedido.",
    ...
    "orders.send_quote": "Enviar cotización",
    "orders.send_via_email": "Enviar por correo",
    "orders.send_via_whatsapp": "Enviar por WhatsApp",
    "orders.order_details": "Detalles del pedido",
    ...
    "orders.notes": "Notas",
    "orders.notes_placeholder": "Agrega notas sobre este pedido...",
    "orders.add_item": "Agregar artículo",
    "orders.remove_item": "Eliminar artículo",
    "orders.create_order": "Crear pedido",
    "orders.update_order": "Actualizar pedido",
    "orders.cancel": "Cancelar",
    "orders.select_customer": "Selecciona un cliente",
    "orders.status_draft": "Borrador",
    "orders.status_pending": "Pendiente",
    "orders.status_sent": "Enviado",
    "orders.status_accepted": "Aceptado",
    "orders.status_rejected": "Rechazado",
    "orders.status_completed": "Completado",
    "orders.search_products": "Buscar productos",
    "orders.search_products_placeholder": "Busca por nombre o SKU...",
    "orders.selected_items": "Artículos seleccionados",

    // Insights
    "insights.title": "Estadísticas",
    "insights.subtitle": "Análisis y métricas de rendimiento",
    "insights.total_revenue": "Ingresos totales",
    "insights.total_orders": "Pedidos totales",
    "insights.total_customers": "Clientes totales",
    "insights.conversion_rate": "Tasa de conversión",
    "insights.revenue_over_time": "Ingresos en el tiempo",
    "insights.orders_by_status": "Pedidos por estado",
    "insights.top_selling_products": "Productos más vendidos",
    "insights.chart_placeholder": "Marcador de posición de gráfico",
  ...
  "en-US": {
    ...
    "dashboard.subtitle": "Welcome back! Here's what's happening with your store.",
    ...
    "catalog.no_products_search": "Try adjusting your search or filter criteria.",
    ...
    "customers.no_customers_search": "Try adjusting your search criteria.",
    "customers.delete_confirm": "Are you sure you want to delete {name}?",
    "customers.contact_information": "Contact Information",
    "customers.name": "Name",
    "customers.phone": "Phone",
    "customers.customer_stats": "Customer Stats",
    "customers.total_orders": "Total Orders",
    "customers.notes": "Notes",
    "customers.new_customer_title": "New Customer",
    "customers.new_customer_subtitle": "Add a new customer to your database",
    "customers.edit_customer_title": "Edit Customer",
    "customers.edit_customer_subtitle": "Update customer information",
    "customers.name_placeholder": "Enter customer name",
    "customers.email_placeholder": "customer@example.com",
    "customers.phone_optional": "Phone (optional)",
    "customers.phone_placeholder": "+1 (555) 123-4567",
    "customers.notes_optional": "Notes (optional)",
    "customers.notes_placeholder": "Add any notes about this customer",
    ...
    // Orders
    "orders.title": "Orders",
    "orders.subtitle": "Create and manage quotes for your customers",
    "orders.new_order": "New Order",
    "orders.add_order": "Add Order",
    "orders.search_orders": "Search orders...",
    "orders.no_orders": "No orders found",
    "orders.no_orders_hint": "Get started by creating your first order.",
    ...
    "orders.send_quote": "Send Quote",
    "orders.send_via_email": "Send via Email",
    "orders.send_via_whatsapp": "Send via WhatsApp",
    ...
    "orders.search_products_placeholder": "Search by name or SKU...",
    "orders.selected_items": "Selected Items",

    // Insights
    "insights.title": "Insights",
    "insights.subtitle": "Analytics and performance metrics",
    ...
    "insights.revenue_over_time": "Revenue Over Time",
    "insights.orders_by_status": "Orders by Status",
    "insights.top_selling_products": "Top Selling Products",
    "insights.chart_placeholder": "Chart placeholder",
